...
const noTopLevelFunctionExpression = {
    create(context) {
        ...
        const scopeTypes = new Set(['global', 'module']);
        const hasGlobalReturn = context.languageOptions.parserOptions?.ecmaFeatures?.globalReturn ===
            true;
        ...
        return {
            VariableDeclarator: (node) => {
                ...
                const currentScope = hasGlobalReturn
                    ? scope.upper
                    : scope;
