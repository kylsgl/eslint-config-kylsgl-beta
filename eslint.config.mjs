import u from 'eslint-plugin-package-json';
import i, { parser as U } from 'typescript-eslint';
import C from '@stylistic/eslint-plugin';
import j from '@vitest/eslint-plugin';
import { importX as H } from 'eslint-plugin-import-x';
import 'eslint-plugin-jsx-a11y';
import _ from 'eslint-plugin-n';
import w from 'eslint-plugin-perfectionist';
import x from 'eslint-plugin-promise';
import 'eslint-plugin-react';
import 'eslint-plugin-react-hooks';
import 'eslint-plugin-react-refresh';
import * as h from 'eslint-plugin-regexp';
import I from 'eslint-plugin-simple-import-sort';
import k from 'eslint-plugin-sonarjs';
import P from 'eslint-plugin-testing-library';
import F from 'eslint-plugin-tsdoc';
import v from 'eslint-plugin-unicorn';
import * as N from 'eslint-import-resolver-typescript';
import L from 'eslint-config-prettier';
const m = {
		base: [
			{
				...
				rules: {
					...
					'@stylistic/array-element-newline': [
						'off',
						{ minItems: 3, multiline: !0 },
					],
					'@stylistic/arrow-parens': ['error', 'always'],
					'@stylistic/arrow-spacing': ['error', { after: !0, before: !0 }],
					...
					'@stylistic/line-comment-position': [
						'off',
						{ applyDefaultPatterns: !0, ignorePattern: '', position: 'above' },
					],
					...
					'@stylistic/no-trailing-spaces': [
						'error',
						{ ignoreComments: !1, skipBlankLines: !1 },
					],
					...
					'@stylistic/quote-props': [
						'error',
						'as-needed',
						{ keywords: !1, numbers: !1, unnecessary: !0 },
					],
					'@stylistic/quotes': ['error', 'single', { avoidEscape: !0 }],
					'@stylistic/rest-spread-spacing': ['error', 'never'],
					'@stylistic/semi': ['error', 'always'],
					'@stylistic/semi-spacing': ['error', { after: !0, before: !1 }],
					...
					camelcase: [
						'error',
						{ ignoreDestructuring: !1, properties: 'never' },
					],
					...
					'import-x/no-unresolved': [
						'error',
						{ caseSensitive: !0, commonjs: !0 },
					],
					'import-x/no-unused-modules': [
						'off',
						{ ignoreExports: [], missingExports: !0, unusedExports: !0 },
					],
					...
					'kylsgl/no-unsafe-division': [
						'error',
						{ ignorePascalCase: !0, ignoreScreamingSnakeCase: !0 },
					],
					...
					'max-lines': [
						'off',
						{ max: 300, skipBlankLines: !0, skipComments: !0 },
					],
					'max-lines-per-function': [
						'off',
						{ IIFEs: !0, max: 50, skipBlankLines: !0, skipComments: !0 },
					],
					...
					'no-implicit-coercion': [
						'off',
						{ allow: [], boolean: !1, number: !0, string: !0 },
					],
					...
					'no-iterator': 'error',
					'no-label-var': 'error',
					'no-labels': ['error', { allowLoop: !1, allowSwitch: !1 }],
					...
					'no-unused-vars': [
						'error',
						{ args: 'after-used', ignoreRestSiblings: !0, vars: 'all' },
					],
					...
					'no-useless-rename': [
						'error',
						{ ignoreDestructuring: !1, ignoreExport: !1, ignoreImport: !1 },
					],
					...
					'object-shorthand': [
						'error',
						'always',
						{ avoidQuotes: !0, ignoreConstructors: !1 },
					],
					'one-var': ['error', 'never'],
					...
					'prefer-arrow-callback': [
						'error',
						{ allowNamedFunctions: !1, allowUnboundThis: !0 },
					],
					'prefer-const': [
						'error',
						{ destructuring: 'any', ignoreReadBeforeAssign: !0 },
					],
					'prefer-destructuring': [
						'error',
						{
							AssignmentExpression: { array: !0, object: !1 },
							VariableDeclarator: { array: !1, object: !0 },
						},
					...
					'sort-keys': ['off', 'asc', { caseSensitive: !1, natural: !0 }],
					'sort-vars': 'off',
					strict: ['error', 'never'],
		...
		typescriptTypeChecked: [
			{
				...
				rules: {
					...
					'@typescript-eslint/consistent-type-exports': [
						'error',
						{ fixMixedExportsWithInlineTypeSpecifier: !0 },
					],
					...
					'@typescript-eslint/no-inferrable-types': [
						'error',
						{ ignoreParameters: !0, ignoreProperties: !0 },
					],
					...
					'@typescript-eslint/prefer-nullish-coalescing': [
						'error',
						{ ignoreConditionalTests: !1, ignoreMixedLogicalExpressions: !1 },
					],
	...
	O = ['{build,dist,out}{,-*,_*}/**', '{coverage,node_modules,patches}/**'],
	T = ['**/*.{js,jsx,cjs,mjs,ts,tsx,cts,mts}'],
	B = ['**/*.{spec,test}.{js,ts}'],
	E = ['**/package.json'],
	f = ['**/*.{ts,tsx,cts,mts}'],
	$ = { ignores: O },
		...
		base: [
			{
				files: E,
				languageOptions: {
					parser: u.configs.recommended.languageOptions.parser,
				},
			},
		],
		typescript: [
	...
	X = new Set(['ArrowFunctionExpression', 'FunctionExpression']),
	z = new Set(['global', 'module']),
	J = {
		create(e) {
			const r =
				e.languageOptions.parserOptions?.ecmaFeatures?.globalReturn === !0;
			return {
				VariableDeclarator: (s) => {
					if (s.init?.type === void 0 || !X.has(s.init.type)) return;
					const o = e.sourceCode.getScope(s),
						n = r ? o.upper : o;
					n != null &&
						z.has(n.type) &&
						e.report({
			...
			const r = (s) => {
				s.params.forEach((o) => {
					o.type === 'AssignmentPattern' &&
						e.report({ messageId: 'noDefaultParams', node: o });
				});
			};
			return {
	...
	Z = new Set(['!=', '!==', '<', '>']);
function D(e) {
	return e.type === 'ReturnStatement' || e.type === 'ThrowStatement';
}
function K(e) {
	return (
		D(e.consequent) ||
		(e.consequent.type === 'BlockStatement' && e.consequent.body.some(D))
	);
}
function d(e, r) {
	switch (e.type) {
		case 'Identifier':
			return r.type === 'Identifier' && e.name === r.name;
		case 'MemberExpression':
			return (
				r.type === 'MemberExpression' &&
				d(e.object, r.object) &&
				d(e.property, r.property)
			);
		default:
			return !1;
	}
...
function Q(e, r, s) {
	const o = d(e.left, r) && e.right.type === 'Literal' && e.right.value === 0,
		n = (s ? Y : Z).has(e.operator);
	return o && n;
}
function p(e, r, s, o, n) {
	switch (r.type) {
		case 'BinaryExpression': {
			const a = o && e.type === 'IfStatement' ? n || K(e) : !0;
			return Q(r, s, o) && a;
		}
		case 'LogicalExpression': {
			const a = p(e, r.left, s, o, n),
				l = p(e, r.right, s, o, n);
			return r.operator === '&&'
				? o
					? a && l
...
function ee(e, r) {
	const s = (n) => (n.type === 'IfStatement' ? p(n, n.test, r, !0, !1) : !1);
	let o = e;
	for (; o.parent != null; ) {
		if (o.parent.type === 'BlockStatement' && o.parent.body.some(s)) return !0;
		o = o.parent;
	}
	return !1;
}
function re(e, r) {
	...
	for (; s.parent != null; ) {
		if (
			(s.parent.type === 'IfStatement' ||
				s.parent.type === 'ConditionalExpression') &&
			p(
				s.parent,
				s.parent.test,
				r,
				s.parent.alternate === s,
				s.parent.alternate === s,
			)
		)
			return !0;
...
function oe(e, r) {
	return e.type === 'Identifier' && r.has(e.name);
}
function S(e, r, s = !1) {
	if (s) {
		if (e.type === 'Identifier') return r.test(e.name);
		if (e.type === 'MemberExpression' && e.object.type === 'Identifier')
			return r.test(e.object.name);
	}
	return !1;
}
function g(e, r, s, o) {
	return (
		...
		ee(e, e.right) ||
		re(e, e.right) ||
		(e.right.type === 'BinaryExpression' && g(e.right, r, s, o))
	);
}
const se = {
		create(e) {
			const r = e.options.at(0),
				s = new Set();
			return {
				AssignmentExpression: (o) => {
					(o.operator !== '/=' && o.operator !== '%=') ||
						g(o, s, r?.ignorePascalCase, r?.ignoreScreamingSnakeCase) ||
						e.report({ messageId: 'noUnsafeDivision', node: o.right });
				},
				BinaryExpression: (o) => {
					(o.operator !== '/' && o.operator !== '%') ||
						g(o, s, r?.ignorePascalCase, r?.ignoreScreamingSnakeCase) ||
			...
			schema: [
				{
					...
					properties: {
						ignorePascalCase: { default: !1, type: 'boolean' },
						ignoreScreamingSnakeCase: { default: !1, type: 'boolean' },
					},
					type: 'object',
				},
			],
	...
	ne = {
		rules: {
			'no-default-params': V,
			'no-toplevel-function-expression': J,
			'no-unsafe-division': se,
		},
	},
	R = {
		base: [
			...
			{ files: E, plugins: { 'package-json': u } },
			{ files: B, plugins: { vitest: j } },
		],
		typescript: [
			{ files: f, plugins: { '@typescript-eslint': i.plugin, tsdoc: F } },
		],
	},
	q = {
		base: [
			{
				...
				settings: {
					'import-x/resolver': {
						node: { extensions: ['.json', 'js', 'jsx', 'cjs', 'mjs'] },
					},
				},
			},
		],
		typescript: [
			{
				...
				settings: {
					'import-x/resolver': {
						...
						node: { extensions: ['.json', 'ts', 'tsx', 'cts', 'mts'] },
						resolver: N,
					},
				},
			},
	...
	y = {
		base: [...R.base, ...A.base, ...q.base, ...m.base, $],
		prettier: m.prettier,
		typescriptTypeChecked: [
			...R.typescript,
			...A.typescript,
			...q.typescript,
			...m.typescriptTypeChecked,
		],
	},
	t = {
		rules: {
			...
			'no-unused-expressions': [
				'error',
				{ allowShortCircuit: !1, allowTaggedTemplates: !1, allowTernary: !1 },
			],
			'require-await': 'off',
		},
	},
	...
	te = { rules: { 'no-array-constructor': 'error' } },
	b = {
		rules: {
			'no-shadow': 'error',
			'no-unused-vars': [
...
(t.rules['default-param-last'],
	t.rules['dot-notation'],
	t.rules['no-empty-function'],
	t.rules['no-implied-eval'],
	t.rules['no-loop-func'],
	t.rules['no-magic-numbers'],
	t.rules['no-unused-expressions'],
	t.rules['no-throw-literal'],
	t.rules['require-await'],
	M.rules['no-useless-constructor'],
	M.rules['prefer-destructuring'],
	te.rules['no-array-constructor'],
	b.rules['no-shadow'],
	b.rules['no-unused-vars'],
	b.rules['no-use-before-define'],
	{ ...u.configs.recommended.rules },
	{ ...w.configs['recommended-natural'].rules },
	{ ...x.configs['flat/recommended'].rules },
	{ ...h.configs['flat/recommended'].rules },
	{ ...k.configs.recommended.rules },
	{ ...j.configs.recommended.rules },
	{ ...v.configs.recommended.rules },
	{ ...L.rules },
	{ ...P.configs['flat/react'].rules });
function c(e) {
	return e.reduce((r, s) => {
		const { rules: o } = s;
		return (
...
(({
	...c(i.configs.recommended),
	...c(i.configs.strict),
	...c(i.configs.stylistic),
}),
	{
		...c(i.configs.recommendedTypeChecked),
		...c(i.configs.strictTypeChecked),
		...c(i.configs.stylisticTypeChecked),
	});
const ae = [
	...y.base,
	...y.typescriptTypeChecked,
	...y.prettier,
	{
