...
const kylsglConfig: Readonly<Linter.Config> = {
	files: FILES_GLOB_JS_TS,
	name: 'kylsgl/base',
	rules: {
...
const perfectionistConfig: Readonly<Linter.Config> = {
	files: FILES_GLOB_JS_TS,
...
const promiseConfig: Readonly<Linter.Config> = {
	files: FILES_GLOB_JS_TS,
	name: 'promise/base',
	rules: {
...
const regexpConfig: Readonly<Linter.Config> = {
	files: FILES_GLOB_JS_TS,
	name: 'regexp/base',
	rules: {
...
const unicornConfig: Readonly<Linter.Config> = {
	files: FILES_GLOB_JS_TS,
	name: 'unicorn/base',
	rules: {
